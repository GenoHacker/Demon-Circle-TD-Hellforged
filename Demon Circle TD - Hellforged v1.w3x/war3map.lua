...
udg_Real_Array_HellfireTowerDamage = __jarray(0.0)
udg_Integer_MaxCreeps = 0
udg_Integer_Array_FluctuationDam = __jarray(0)
udg_UnitType_Array_FluctuationTow = __jarray(0)
...
udg_Integer_Array_AnomalyAbility3 = __jarray(0)
...
gg_trg_Anomaly_Tower_Main = nil
gg_trg_Bladestorm_Dummy_Fix = nil
gg_trg_Infernal_Core_and_Volatile_Catalyst = nil
...
gg_trg_Inferno_Gate_Soul_Fire = nil
...
while (true) do
if ((i > 1)) then break end
udg_Integer_Array_HellfireTower[i] = 0
i = i + 1
end
i = 0
while (true) do
if ((i > 1)) then break end
udg_Integer_Array_SoulfireChance[i] = 0
i = i + 1
end
i = 0
while (true) do
if ((i > 1)) then break end
udg_Real_Array_HellfireTowerDamage[i] = 0.0
i = i + 1
end
udg_Integer_MaxCreeps = 300
i = 0
while (true) do
if ((i > 1)) then break end
udg_Integer_Array_FluctuationDam[i] = 0
i = i + 1
end
i = 0
while (true) do
if ((i > 1)) then break end
udg_Real_Array_MonsterTRadius[i] = 0.0
i = i + 1
end
i = 0
while (true) do
if ((i > 1)) then break end
udg_Real_Array_MonsterTDamage[i] = 0.0
i = i + 1
end
i = 0
while (true) do
...
while (true) do
if ((i > 1)) then break end
udg_Integer_Array_AnomalyAbility1[i] = 0
i = i + 1
end
i = 0
while (true) do
if ((i > 1)) then break end
udg_Integer_Array_AnomalyAbility2[i] = 0
i = i + 1
end
i = 0
while (true) do
if ((i > 1)) then break end
udg_Integer_Array_AnomalyAbility3[i] = 0
i = i + 1
end
i = 0
while (true) do
if ((i > 1)) then break end
udg_Integer_Array_AnomalyAbility4[i] = 0
i = i + 1
end
i = 0
while (true) do
...
while (true) do
if ((i > 1)) then break end
udg_Real_Array_SiphoningAOE[i] = 0.0
i = i + 1
end
i = 0
while (true) do
if ((i > 1)) then break end
udg_Real_Array_SiphonTowerManaGain[i] = 0.0
i = i + 1
end
i = 0
while (true) do
if ((i > 1)) then break end
udg_Real_Array_SiphonTowerManaLoss[i] = 0.0
i = i + 1
end
i = 0
while (true) do
if ((i > 1)) then break end
udg_Real_Array_FrostTowArmorReduce[i] = 0.0
i = i + 1
end
i = 0
while (true) do
...
udg_Integer_SpawnIncreaseAmount = 2
i = 0
while (true) do
if ((i > 1)) then break end
udg_String_Array_ArmourType[i] = ""
i = i + 1
end
udg_Integer_ArmourTypeCounter = 0
...
gg_snd_ReceiveGold = CreateSound("Abilities/Spells/Items/ResourceItems/ReceiveGold.flac", false, true, false, 1, 1, "SpellsEAX")
SetSoundParamsFromLabel(gg_snd_ReceiveGold, "ReceiveGold")
SetSoundDuration(gg_snd_ReceiveGold, 589)
SetSoundChannel(gg_snd_ReceiveGold, 1)
...
u = BlzCreateUnitWithSkin(p, FourCC("n007"), -2888.6, 2055.5, 164.657, FourCC("n007"))
u = BlzCreateUnitWithSkin(p, FourCC("n007"), -2196.5, 1971.6, 73.885, FourCC("n007"))
u = BlzCreateUnitWithSkin(p, FourCC("n007"), -5980.1, 2048.0, 67.491, FourCC("n007"))
u = BlzCreateUnitWithSkin(p, FourCC("n007"), -4867.7, -293.1, 142.937, FourCC("n007"))
u = BlzCreateUnitWithSkin(p, FourCC("n007"), -2564.5, -1373.5, 16.656, FourCC("n007"))
u = BlzCreateUnitWithSkin(p, FourCC("n007"), -220.4, -260.8, 34.421, FourCC("n007"))
u = BlzCreateUnitWithSkin(p, FourCC("n007"), 891.2, 2069.9, 236.301, FourCC("n007"))
u = BlzCreateUnitWithSkin(p, FourCC("n007"), -256.1, 4359.9, 84.378, FourCC("n007"))
u = BlzCreateUnitWithSkin(p, FourCC("n007"), -2510.3, 5461.7, 294.959, FourCC("n007"))
u = BlzCreateUnitWithSkin(p, FourCC("n007"), -4855.7, 4332.7, 308.747, FourCC("n007"))
end
...
function Trig_Map_Initialization_Func032Func001Func001C()
...
function Trig_Map_Initialization_Func032Func004Func003C()
...
function Trig_Map_Initialization_Func032Func004C()
if (not Trig_Map_Initialization_Func032Func004Func003C()) then
return false
end
return true
end

function Trig_Map_Initialization_Func032Func005C()
...
function Trig_Map_Initialization_Func034Func003Func001C()
...
function Trig_Map_Initialization_Func034Func004C()
...
if (Trig_Map_Initialization_Func032Func001Func001C()) then
...
while (true) do
if (bj_forLoopBIndex > bj_forLoopBIndexEnd) then break end
if (Trig_Map_Initialization_Func034Func003Func001C()) then
...
if (Trig_Map_Initialization_Func034Func004C()) then
...
udg_AbilityCode_Array_AnomTowDummy[5] = FourCC("A02E")
...
udg_AbilityCode_Array_AnomTowDummy[9] = FourCC("A02C")
...
udg_AbilityCode_Array_AnomalyTower[2] = FourCC("A033")
udg_AbilityCode_Array_AnomalyTower[3] = FourCC("A013")
udg_AbilityCode_Array_AnomalyTower[4] = FourCC("A015")
udg_AbilityCode_Array_AnomalyTower[5] = FourCC("A02Q")
...
udg_Real_Array_FrostTowArmorReduce[1] = 1.00
udg_Real_Array_FrostTowArmorReduce[2] = 2.00
udg_Real_Array_FrostTowArmorReduce[3] = 4.00
udg_Real_Array_SiphonTowerManaGain[1] = 0.10
udg_Real_Array_SiphonTowerManaGain[2] = 0.20
udg_Real_Array_SiphonTowerManaGain[3] = 0.30
udg_Real_Array_SiphonTowerManaLoss[1] = 40.00
udg_Real_Array_SiphonTowerManaLoss[2] = 80.00
udg_Real_Array_SiphonTowerManaLoss[3] = 160.00
udg_Real_Array_SiphoningAOE[1] = 75.00
udg_Real_Array_SiphoningAOE[2] = 100.00
udg_Real_Array_SiphoningAOE[3] = 125.00
...
udg_Real_Array_HellfireTowerDamage[3] = 400.00
udg_Real_Array_HellfireTowerDamage[4] = 600.00
udg_Real_Array_HellfireTowerDamage[5] = 800.00
udg_Integer_Array_FluctuationDam[1] = 250
udg_Integer_Array_FluctuationDam[2] = 500
udg_Integer_Array_FluctuationDam[3] = 1000
udg_Integer_Array_SoulfireChance[0] = 0
...
udg_UnitType_Array_FluctuationTow[1] = FourCC("u01F")
udg_UnitType_Array_FluctuationTow[2] = FourCC("u01D")
udg_UnitType_Array_FluctuationTow[3] = FourCC("u01E")
...
LeaderboardAddItemBJ(udg_Player, udg_LeaderBoard_Kills, "TRIGSTR_1908", 0)
end
end
...
MultiboardSetItemValueBJ(udg_Multiboard[9], 2, 3, (("|cffffff00" .. I2S(udg_Integer_NumberOfCreeps)) .. ("/" .. I2S(udg_Integer_MaxCreeps))))
...
function InitTrig_Show_Mods()
gg_trg_Show_Mods = CreateTrigger()
TriggerRegisterPlayerChatEvent(gg_trg_Show_Mods, Player(0), "-mod", false)
TriggerRegisterPlayerChatEvent(gg_trg_Show_Mods, Player(1), "-mod", false)
TriggerRegisterPlayerChatEvent(gg_trg_Show_Mods, Player(2), "-mod", false)
TriggerRegisterPlayerChatEvent(gg_trg_Show_Mods, Player(3), "-mod", false)
TriggerRegisterPlayerChatEvent(gg_trg_Show_Mods, Player(4), "-mod", false)
TriggerRegisterPlayerChatEvent(gg_trg_Show_Mods, Player(5), "-mod", false)
TriggerRegisterPlayerChatEvent(gg_trg_Show_Mods, Player(6), "-mod", false)
TriggerRegisterPlayerChatEvent(gg_trg_Show_Mods, Player(7), "-mod", false)
TriggerAddAction(gg_trg_Show_Mods, Trig_Show_Mods_Actions)
end
...
LeaderboardDisplayBJ(true, udg_LeaderBoard_Kills)
else
...
DialogAddButtonBJ(udg_Dialog_Difficulty, "TRIGSTR_1902")
udg_DialogButton_Array_Difficulty[2] = GetLastCreatedButtonBJ()
DialogAddButtonBJ(udg_Dialog_Difficulty, "TRIGSTR_2254")
...
DisplayTextToForce(GetPlayersAll(), (GetPlayerName(GetTriggerPlayer()) .. " has selected Difficulty++"))
udg_Integer_MaxCreeps = (udg_Integer_MaxCreeps - 20)
MultiboardSetItemValueBJ(udg_Multiboard[9], 2, 3, (("|cffffff00" .. I2S(udg_Integer_NumberOfCreeps)) .. ("/" .. I2S(udg_Integer_MaxCreeps))))
...
if (not (udg_Integer_NumberOfCreeps ~= 0)) then
return false
end
...
function Trig_Next_Wave_Func002Func005A()
...
udg_Real_WaveTimer = 100.00
TriggerSleepAction(30.00)
ForForce(GetPlayersAll(), Trig_Next_Wave_Func002Func005A)
return 
else
...
CreateNUnitsAtLoc(1, udg_UT_UnitType[udg_Integer_Wave], Player(10), udg_Point_Array_WaveSpawnpoint[udg_Player_Number], udg_Real_Array_SpawnDegrees[udg_Player_Number])
else
...
BlzSetUnitArmor(udg_Creep, (BlzGetUnitArmor(udg_Creep) + (I2R(udg_Integer_Wave) * 0.10)))
UnitAddAbilityBJ(FourCC("Aeth"), udg_Creep)
end

function Trig_Wave_Spawning_Func007Func001C()
...
function Trig_Wave_Spawning_Func007Func006Func001C()
if (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 1)] == 1) then
return true
end
if (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 2)] == 1) then
return true
end
if (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 3)] == 1) then
return true
end
return false
end

function Trig_Wave_Spawning_Func007Func006C()
if (not Trig_Wave_Spawning_Func007Func006Func001C()) then
return false
end
return true
end
...
if (not Trig_Wave_Spawning_Func007Func006C()) then
return false
end
return true
end
...
if (Trig_Wave_Spawning_Func007Func001C()) then
udg_Integer_Spawncount = 0
DisableTrigger(GetTriggeringTrigger())
else
end
...
DisableTrigger(gg_trg_Wave_Spawning)
...
function Trig_Wave_Buffs_New_Func003Func004Func001Func003Func001Func001C()
if (not (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 1)] >= 4)) then
return false
end
return true
end

function Trig_Wave_Buffs_New_Func003Func004Func001Func003Func001C()
if (not (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 1)] == 3)) then
return false
end
return true
end

function Trig_Wave_Buffs_New_Func003Func004Func001Func003C()
if (not (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 1)] == 2)) then
return false
end
return true
end
...
if (not (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 1)] == 1)) then
return false
end
return true
end
...
if (not (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 1)] ~= 0)) then
return false
end
return true
end

function Trig_Wave_Buffs_New_Func003Func008Func001Func003Func001Func001C()
if (not (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 2)] >= 4)) then
return false
end
return true
end

function Trig_Wave_Buffs_New_Func003Func008Func001Func003Func001C()
if (not (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 2)] == 3)) then
return false
end
return true
end

function Trig_Wave_Buffs_New_Func003Func008Func001Func003C()
if (not (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 2)] == 2)) then
return false
end
return true
end

function Trig_Wave_Buffs_New_Func003Func008Func001C()
if (not (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 2)] == 1)) then
return false
end
return true
end

function Trig_Wave_Buffs_New_Func003Func008C()
if (not (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 2)] ~= 0)) then
return false
end
return true
end

function Trig_Wave_Buffs_New_Func003Func012Func001Func003Func001Func001C()
if (not (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 3)] >= 4)) then
return false
end
return true
end

function Trig_Wave_Buffs_New_Func003Func012Func001Func003Func001C()
if (not (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 3)] == 3)) then
return false
end
return true
end

function Trig_Wave_Buffs_New_Func003Func012Func001Func003C()
if (not (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 3)] == 2)) then
return false
end
return true
end

function Trig_Wave_Buffs_New_Func003Func012Func001C()
if (not (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 3)] == 1)) then
return false
end
return true
end

function Trig_Wave_Buffs_New_Func003Func012C()
if (not (udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 3)] ~= 0)) then
return false
end
return true
end
...
udg_Integer_ModToGive = udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 1)]
...
UnitApplyTimedLifeBJ(1.00, FourCC("BTLF"), GetLastCreatedUnit())
UnitAddAbilityBJ(udg_AbilityCode_Array_ModAbilities[udg_Integer_ModToGive], GetLastCreatedUnit())
SetUnitAbilityLevelSwapped(udg_AbilityCode_Array_ModAbilities[udg_Integer_ModToGive], GetLastCreatedUnit(), udg_Integer_ModLevelToGive)
IssueTargetOrderBJ(GetLastCreatedUnit(), "banish", GetTriggerUnit())
                    RemoveLocation(udg_Temp_PointA)
else
if (Trig_Wave_Buffs_New_Func003Func004Func001Func003Func001C()) then
UnitAddAbilityBJ(udg_AbilityCode_Array_ModAbilities[udg_Integer_ModToGive], GetTriggerUnit())
SetUnitAbilityLevelSwapped(udg_AbilityCode_Array_ModAbilities[udg_Integer_ModToGive], GetTriggerUnit(), udg_Integer_ModLevelToGive)
BlzSetUnitMaxMana(GetTriggerUnit(), ((BlzGetUnitMaxHP(GetTriggerUnit()) // 2) + 100))
SetUnitManaPercentBJ(GetTriggerUnit(), 100)
else
if (Trig_Wave_Buffs_New_Func003Func004Func001Func003Func001Func001C()) then
UnitAddAbilityBJ(udg_AbilityCode_Array_ModAbilities[udg_Integer_ModToGive], GetTriggerUnit())
SetUnitAbilityLevelSwapped(udg_AbilityCode_Array_ModAbilities[udg_Integer_ModToGive], GetTriggerUnit(), udg_Integer_ModLevelToGive)
else
end
...
udg_Integer_ModToGive = udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 2)]
...
if (Trig_Wave_Buffs_New_Func003Func008Func001Func003Func001C()) then
UnitAddAbilityBJ(udg_AbilityCode_Array_ModAbilities[udg_Integer_ModToGive], GetTriggerUnit())
SetUnitAbilityLevelSwapped(udg_AbilityCode_Array_ModAbilities[udg_Integer_ModToGive], GetTriggerUnit(), udg_Integer_ModLevelToGive)
BlzSetUnitMaxMana(GetTriggerUnit(), ((BlzGetUnitMaxHP(GetTriggerUnit()) // 2) + 100))
SetUnitManaPercentBJ(GetTriggerUnit(), 100)
else
if (Trig_Wave_Buffs_New_Func003Func008Func001Func003Func001Func001C()) then
UnitAddAbilityBJ(udg_AbilityCode_Array_ModAbilities[udg_Integer_ModToGive], GetTriggerUnit())
SetUnitAbilityLevelSwapped(udg_AbilityCode_Array_ModAbilities[udg_Integer_ModToGive], GetTriggerUnit(), udg_Integer_ModLevelToGive)
else
end
...
udg_Integer_ModToGive = udg_Integer_Array_WaveMod[(((udg_Integer_Wave - 1) * 3) + 3)]
...
if (Trig_Wave_Buffs_New_Func003Func012Func001Func003Func001C()) then
UnitAddAbilityBJ(udg_AbilityCode_Array_ModAbilities[udg_Integer_ModToGive], GetTriggerUnit())
SetUnitAbilityLevelSwapped(udg_AbilityCode_Array_ModAbilities[udg_Integer_ModToGive], GetTriggerUnit(), udg_Integer_ModLevelToGive)
BlzSetUnitMaxMana(GetTriggerUnit(), ((BlzGetUnitMaxHP(GetTriggerUnit()) // 2) + 100))
SetUnitManaPercentBJ(GetTriggerUnit(), 100)
else
if (Trig_Wave_Buffs_New_Func003Func012Func001Func003Func001Func001C()) then
UnitAddAbilityBJ(udg_AbilityCode_Array_ModAbilities[udg_Integer_ModToGive], GetTriggerUnit())
SetUnitAbilityLevelSwapped(udg_AbilityCode_Array_ModAbilities[udg_Integer_ModToGive], GetTriggerUnit(), udg_Integer_ModLevelToGive)
else
end
...
function Trig_Lives_Func001Func006Func001Func001C()
if (not (udg_Real_Lives >= 30.00)) then
return false
end
return true
...
function Trig_Lives_Func001Func006Func001C()
if (not (udg_Real_Lives >= 50.00)) then
return false
end
return true
...
function Trig_Lives_Func001Func006C()
if (not (udg_Real_Lives >= 75.00)) then
return false
end
return true
...
if (not (udg_Integer_NumberOfCreeps >= udg_Integer_MaxCreeps)) then
return false
end
return true
end
...
if (Trig_Lives_Func001Func008C()) then
ForForce(GetPlayersAll(), Trig_Lives_Func001Func008Func001A)
else
end
else
MultiboardSetItemValueBJ(udg_Multiboard[9], 2, 1, "TRIGSTR_2079")
end
end
...
if (not (GetUnitTypeId(udg_Dying_Unit) ~= FourCC("n006"))) then
return false
end
...
if (udg_Dying_Unit_Type == FourCC("h029")) then
return true
end
if (udg_Dying_Unit_Type == FourCC("h02A")) then
return true
end
return false
end
...
udg_Integer_Kills[udg_Player_Number_Extra] = (udg_Integer_Kills[udg_Player_Number_Extra] + 1)
LeaderboardSetPlayerItemValueBJ(udg_Owner_Of_Killing_Unit, udg_LeaderBoard_Kills, udg_Integer_Kills[udg_Player_Number_Extra])
udg_Integer_NumberOfCreeps = (udg_Integer_NumberOfCreeps - 1)
MultiboardSetItemValueBJ(udg_Multiboard[9], 2, 3, (("|cffffff00" .. I2S(udg_Integer_NumberOfCreeps)) .. ("/" .. I2S(udg_Integer_MaxCreeps))))
...
function Trig_Leaving_Players_Func009C()
if (not (udg_Integer_Array_DifficultyVote[GetConvertedPlayerId(GetTriggerPlayer())] == 1)) then
return false
end
return true
end
...
MultiboardSetItemValueBJ(udg_Multiboard[9], 2, 3, (I2S(udg_Integer_NumberOfCreeps) .. ("/" .. I2S(udg_Integer_MaxCreeps))))
if (Trig_Leaving_Players_Func009C()) then
udg_Integer_MaxSpawncount = (udg_Integer_MaxSpawncount - udg_Integer_SpawnIncreaseAmount)
MultiboardSetItemValueBJ(udg_Multiboard[9], 2, 11, I2S(udg_Integer_MaxSpawncount))
else
end
LeaderboardSetPlayerItemLabelBJ(GetTriggerPlayer(), udg_LeaderBoard_Kills, "TRIGSTR_1900")
...
udg_PlayerGroup_SellTower = GetForceOfPlayer(GetOwningPlayer(GetTriggerUnit()))
DisplayTextToForce(udg_PlayerGroup_SellTower, ("|cffffcc00You get " .. (I2S(GetUnitPointValue(GetTriggerUnit())) .. (" gold for selling a " .. (GetUnitName(GetTriggerUnit()) .. ".|r")))))
...
function Trig_Anomaly_Tower_Main_Conditions()
if (not (GetUnitAbilityLevelSwapped(FourCC("A01W"), GetEventDamageSource()) >= 1)) then
return false
end
if (not (GetUnitTypeId(GetEventDamageSource()) ~= FourCC("u005"))) then
return false
end
return true
end

function Trig_Anomaly_Tower_Main_Func007Func011Func001C()
if (udg_Integer_Array_AnomalyAbility1[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] == 2) then
return true
end
if (udg_Integer_Array_AnomalyAbility1[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] == 5) then
return true
end
return false
end

function Trig_Anomaly_Tower_Main_Func007Func011Func003Func003C()
if (not (udg_Integer_Array_AnomalyAbility1[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] == 5)) then
return false
end
return true
end

function Trig_Anomaly_Tower_Main_Func007Func011Func003C()
if (not (udg_Integer_Array_AnomalyAbility1[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] == 2)) then
return false
end
return true
end

function Trig_Anomaly_Tower_Main_Func007Func011C()
if (not Trig_Anomaly_Tower_Main_Func007Func011Func001C()) then
return false
end
return true
end

function Trig_Anomaly_Tower_Main_Func007Func027Func001C()
...
function Trig_Anomaly_Tower_Main_Func007Func027C()
if (not Trig_Anomaly_Tower_Main_Func007Func027Func001C()) then
return false
end
return true
end

function Trig_Anomaly_Tower_Main_Func007Func031Func002Func004C()
...
function Trig_Anomaly_Tower_Main_Func007Func031Func002Func005C()
...
function Trig_Anomaly_Tower_Main_Func007Func031Func002C()
if (not Trig_Anomaly_Tower_Main_Func007Func031Func002Func005C()) then
return false
end
return true
end

function Trig_Anomaly_Tower_Main_Func007Func031C()
...
function Trig_Anomaly_Tower_Main_Func007Func050Func001Func003C()
if (not (udg_Integer_Array_AnomalyAbility1[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] == 5)) then
return false
end
return true
...
function Trig_Anomaly_Tower_Main_Func007Func050Func001C()
if (not (udg_Integer_Array_AnomalyAbility1[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] == 2)) then
return false
end
return true
...
function Trig_Anomaly_Tower_Main_Func007Func050Func002C()
if (udg_Integer_Array_AnomalyAbility1[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] == 2) then
return true
end
if (udg_Integer_Array_AnomalyAbility1[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] == 5) then
...
function Trig_Anomaly_Tower_Main_Func007Func050C()
if (not Trig_Anomaly_Tower_Main_Func007Func050Func002C()) then
return false
end
return true
end

function Trig_Anomaly_Tower_Main_Func007Func066Func001C()
if (GetUnitTypeId(GetEventDamageSource()) == FourCC("u01K")) then
return true
end
if (GetUnitTypeId(GetEventDamageSource()) == FourCC("u01L")) then
...
function Trig_Anomaly_Tower_Main_Func007Func066C()
if (not Trig_Anomaly_Tower_Main_Func007Func066Func001C()) then
return false
end
return true
end

function Trig_Anomaly_Tower_Main_Func007Func070Func002Func004C()
if (not (udg_Integer_Array_AnomalyAbility4[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] == 20)) then
return false
end
return true
...
function Trig_Anomaly_Tower_Main_Func007Func070Func002Func005C()
if (udg_Integer_Array_AnomalyAbility4[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] == 16) then
return true
end
if (udg_Integer_Array_AnomalyAbility4[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] == 18) then
...
function Trig_Anomaly_Tower_Main_Func007Func070Func002C()
if (not Trig_Anomaly_Tower_Main_Func007Func070Func002Func005C()) then
return false
end
return true
end

function Trig_Anomaly_Tower_Main_Func007Func070C()
if (not (GetUnitTypeId(GetEventDamageSource()) == FourCC("u01L"))) then
return false
end
return true
...
function Trig_Anomaly_Tower_Main_Func007C()
...
function Trig_Anomaly_Tower_Main_Func011002003()
return (IsUnitEnemy(GetFilterUnit(), GetOwningPlayer(GetEventDamageSource())) == true)
end

function Trig_Anomaly_Tower_Main_Func012A()
IssueImmediateOrderBJ(GetEnumUnit(), "immolation")
...
function Trig_Anomaly_Tower_Main_Actions()
udg_Temp_PointA = GetUnitLoc(GetEventDamageSource())
if (Trig_Anomaly_Tower_Main_Func007C()) then
SetUnitManaBJ(GetEventDamageSource(), 0)
UnitRemoveAbilityBJ(udg_AbilityCode_Array_AnomTowDummy[udg_Integer_Array_AnomalyAbility1[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))]], GetEventDamageSource())
UnitRemoveAbilityBJ(udg_AbilityCode_Array_AnomTowDummy[udg_Integer_Array_AnomalyAbility2[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))]], GetEventDamageSource())
UnitRemoveAbilityBJ(udg_AbilityCode_Array_AnomTowDummy[udg_Integer_Array_AnomalyAbility3[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))]], GetEventDamageSource())
UnitRemoveAbilityBJ(udg_AbilityCode_Array_AnomTowDummy[udg_Integer_Array_AnomalyAbility4[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))]], GetEventDamageSource())
...
if (Trig_Anomaly_Tower_Main_Func007Func050C()) then
if (Trig_Anomaly_Tower_Main_Func007Func050Func001C()) then
CreateNUnitsAtLoc(1, FourCC("h02B"), GetOwningPlayer(GetEventDamageSource()), udg_Temp_PointAnomaly[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))], bj_UNIT_FACING)
UnitApplyTimedLifeBJ(4.00, FourCC("BTLF"), GetLastCreatedUnit())
else
if (Trig_Anomaly_Tower_Main_Func007Func050Func001Func003C()) then
...
UnitApplyTimedLifeBJ(4.00, FourCC("BTLF"), GetLastCreatedUnit())
AddSpecialEffectLocBJ(udg_Temp_PointAnomaly[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))], "Abilities\\Spells\\Human\\ThunderClap\\ThunderClapCaster.mdl")
...
if (Trig_Anomaly_Tower_Main_Func007Func066C()) then
CreateNUnitsAtLoc(1, FourCC("h02A"), GetOwningPlayer(GetEventDamageSource()), udg_Temp_PointA, bj_UNIT_FACING)
UnitApplyTimedLifeBJ(4.00, FourCC("BTLF"), GetLastCreatedUnit())
GroupAddUnitSimple(GetLastCreatedUnit(), udg_UnitGroup_Array_AnomDummys1[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))])
...
if (Trig_Anomaly_Tower_Main_Func007Func070C()) then
if (Trig_Anomaly_Tower_Main_Func007Func070Func002C()) then
udg_Temp_PointAnomaly[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] = GetUnitLoc(BlzGetEventDamageTarget())
CreateNUnitsAtLoc(1, FourCC("h02A"), GetOwningPlayer(GetEventDamageSource()), udg_Temp_PointAnomaly[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))], bj_UNIT_FACING)
UnitApplyTimedLifeBJ(4.00, FourCC("BTLF"), GetLastCreatedUnit())
else
if (Trig_Anomaly_Tower_Main_Func007Func070Func002Func004C()) then
udg_Temp_PointAnomaly[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] = GetUnitLoc(BlzGetEventDamageTarget())
...
UnitRemoveAbilityBJ(udg_AbilityCode_Array_AnomTowDummy[udg_Integer_Array_AnomalyAbility3[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))]], GetEventDamageSource())
UnitRemoveAbilityBJ(udg_AbilityCode_Array_AnomTowDummy[udg_Integer_Array_AnomalyAbility4[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))]], GetEventDamageSource())
if (Trig_Anomaly_Tower_Main_Func007Func011C()) then
udg_Temp_PointAnomaly[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] = GetUnitLoc(BlzGetEventDamageTarget())
if (Trig_Anomaly_Tower_Main_Func007Func011Func003C()) then
CreateNUnitsAtLoc(1, FourCC("h02B"), GetOwningPlayer(GetEventDamageSource()), udg_Temp_PointAnomaly[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))], bj_UNIT_FACING)
UnitApplyTimedLifeBJ(4.00, FourCC("BTLF"), GetLastCreatedUnit())
else
if (Trig_Anomaly_Tower_Main_Func007Func011Func003Func003C()) then
CreateNUnitsAtLoc(1, FourCC("h02A"), GetOwningPlayer(GetEventDamageSource()), udg_Temp_PointAnomaly[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))], bj_UNIT_FACING)
UnitApplyTimedLifeBJ(4.00, FourCC("BTLF"), GetLastCreatedUnit())
AddSpecialEffectLocBJ(udg_Temp_PointAnomaly[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))], "Abilities\\Spells\\Human\\ThunderClap\\ThunderClapCaster.mdl")
DestroyEffectBJ(GetLastCreatedEffectBJ())
...
SetUnitAbilityLevelSwapped(udg_AbilityCode_Array_AnomalyTower[udg_Integer_Array_AnomalyAbility2[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))]], GetLastCreatedUnit(), (1 + GetItemCharges(GetItemOfTypeFromUnitBJ(GetEventDamageSource(), FourCC("I008")))))
SetUnitAbilityLevelSwapped(udg_AbilityCode_Array_AnomTowDummy[udg_Integer_Array_AnomalyAbility2[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))]], GetEventDamageSource(), (1 + GetItemCharges(GetItemOfTypeFromUnitBJ(GetEventDamageSource(), FourCC("I008")))))
if (Trig_Anomaly_Tower_Main_Func007Func027C()) then
CreateNUnitsAtLoc(1, FourCC("h02A"), GetOwningPlayer(GetEventDamageSource()), udg_Temp_PointA, bj_UNIT_FACING)
UnitApplyTimedLifeBJ(4.00, FourCC("BTLF"), GetLastCreatedUnit())
GroupAddUnitSimple(GetLastCreatedUnit(), udg_UnitGroup_Array_AnomDummys1[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))])
UnitAddAbilityBJ(udg_AbilityCode_Array_AnomalyTower[udg_Integer_Array_AnomalyAbility3[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))]], GetLastCreatedUnit())
...
if (Trig_Anomaly_Tower_Main_Func007Func031C()) then
if (Trig_Anomaly_Tower_Main_Func007Func031Func002C()) then
udg_Temp_PointAnomaly[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] = GetUnitLoc(BlzGetEventDamageTarget())
CreateNUnitsAtLoc(1, FourCC("h02A"), GetOwningPlayer(GetEventDamageSource()), udg_Temp_PointAnomaly[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))], bj_UNIT_FACING)
UnitApplyTimedLifeBJ(4.00, FourCC("BTLF"), GetLastCreatedUnit())
else
if (Trig_Anomaly_Tower_Main_Func007Func031Func002Func004C()) then
udg_Temp_PointAnomaly[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] = GetUnitLoc(BlzGetEventDamageTarget())
CreateNUnitsAtLoc(1, FourCC("h029"), GetOwningPlayer(GetEventDamageSource()), udg_Temp_PointAnomaly[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))], bj_UNIT_FACING)
UnitApplyTimedLifeBJ(4.00, FourCC("BTLF"), GetLastCreatedUnit())
else
...
SetUnitAbilityLevelSwapped(udg_AbilityCode_Array_AnomTowDummy[udg_Integer_Array_AnomalyAbility4[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))]], GetEventDamageSource(), (1 + GetItemCharges(GetItemOfTypeFromUnitBJ(GetEventDamageSource(), FourCC("I008")))))
    ...
    RemoveLocation(udg_Temp_PointAnomaly[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))])
    RemoveLocation(udg_Temp_PointA)
udg_Temp_PointB = GetUnitLoc(BlzGetEventDamageTarget())
udg_UnitGroup_Array_AnomDummys2[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] = GetUnitsInRangeOfLocMatching(300.00, udg_Temp_PointB, Condition(Trig_Anomaly_Tower_Main_Func011002003))
ForGroupBJ(udg_UnitGroup_Array_AnomDummys1[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))], Trig_Anomaly_Tower_Main_Func012A)
GroupClear(udg_UnitGroup_Array_AnomDummys1[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))])
GroupClear(udg_UnitGroup_Array_AnomDummys2[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))])
    RemoveLocation(udg_Temp_PointB)
end

function InitTrig_Anomaly_Tower_Main()
gg_trg_Anomaly_Tower_Main = CreateTrigger()
TriggerRegisterAnyUnitEventBJ(gg_trg_Anomaly_Tower_Main, EVENT_PLAYER_UNIT_DAMAGED)
TriggerAddCondition(gg_trg_Anomaly_Tower_Main, Condition(Trig_Anomaly_Tower_Main_Conditions))
TriggerAddAction(gg_trg_Anomaly_Tower_Main, Trig_Anomaly_Tower_Main_Actions)
end
...
gg_trg_Anomaly_Tower_Level_Up_Ability = CreateTrigger()
...
function Trig_Bladestorm_Dummy_Fix_Conditions()
...
function Trig_Bladestorm_Dummy_Fix_Actions()
UnitApplyTimedLifeBJ(4.00, FourCC("BTLF"), GetSpellAbilityUnit())
end

function InitTrig_Bladestorm_Dummy_Fix()
gg_trg_Bladestorm_Dummy_Fix = CreateTrigger()
TriggerRegisterAnyUnitEventBJ(gg_trg_Bladestorm_Dummy_Fix, EVENT_PLAYER_UNIT_SPELL_CAST)
TriggerAddCondition(gg_trg_Bladestorm_Dummy_Fix, Condition(Trig_Bladestorm_Dummy_Fix_Conditions))
TriggerAddAction(gg_trg_Bladestorm_Dummy_Fix, Trig_Bladestorm_Dummy_Fix_Actions)
end

function Trig_Infernal_Core_and_Volatile_Catalyst_Conditions()
if (not (GetUnitAbilityLevelSwapped(FourCC("A01R"), GetEventDamageSource()) == 1)) then
return false
end
return true
end

function Trig_Infernal_Core_and_Volatile_Catalyst_Func002C()
...
function Trig_Infernal_Core_and_Volatile_Catalyst_Func003Func001C()
...
function Trig_Infernal_Core_and_Volatile_Catalyst_Func003C()
if (not Trig_Infernal_Core_and_Volatile_Catalyst_Func003Func001C()) then
return false
end
return true
end

function Trig_Infernal_Core_and_Volatile_Catalyst_Actions()
udg_Integer_Array_HellfireTower[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] = GetRandomInt(1, 100)
if (Trig_Infernal_Core_and_Volatile_Catalyst_Func002C()) then
...
if (Trig_Infernal_Core_and_Volatile_Catalyst_Func003C()) then
udg_Temp_PointB = GetUnitLoc(BlzGetEventDamageTarget())
...
function InitTrig_Infernal_Core_and_Volatile_Catalyst()
gg_trg_Infernal_Core_and_Volatile_Catalyst = CreateTrigger()
TriggerRegisterAnyUnitEventBJ(gg_trg_Infernal_Core_and_Volatile_Catalyst, EVENT_PLAYER_UNIT_DAMAGED)
TriggerAddCondition(gg_trg_Infernal_Core_and_Volatile_Catalyst, Condition(Trig_Infernal_Core_and_Volatile_Catalyst_Conditions))
TriggerAddAction(gg_trg_Infernal_Core_and_Volatile_Catalyst, Trig_Infernal_Core_and_Volatile_Catalyst_Actions)
end

function Trig_Fluctuation_Tower_Ability_Conditions()
...
function InitTrig_Fluctuation_Tower_Ability()
gg_trg_Fluctuation_Tower_Ability = CreateTrigger()
TriggerRegisterAnyUnitEventBJ(gg_trg_Fluctuation_Tower_Ability, EVENT_PLAYER_UNIT_DAMAGED)
TriggerAddCondition(gg_trg_Fluctuation_Tower_Ability, Condition(Trig_Fluctuation_Tower_Ability_Conditions))
...
function Trig_Monstrosity_Tower_Sanguine_Stacks_Conditions()
if (not (GetUnitAbilityLevelSwapped(FourCC("A01Y"), GetEventDamageSource()) == 1)) then
return false
end
return true
end
...
gg_trg_Monstrosity_Tower_Sanguine_Stacks = CreateTrigger()
TriggerRegisterAnyUnitEventBJ(gg_trg_Monstrosity_Tower_Sanguine_Stacks, EVENT_PLAYER_UNIT_DAMAGED)
TriggerAddCondition(gg_trg_Monstrosity_Tower_Sanguine_Stacks, Condition(Trig_Monstrosity_Tower_Sanguine_Stacks_Conditions))
TriggerAddAction(gg_trg_Monstrosity_Tower_Sanguine_Stacks, Trig_Monstrosity_Tower_Sanguine_Stacks_Actions)
end

function Trig_Soul_Eater_and_Carrion_Tower_Conditions()
...
function InitTrig_Soul_Eater_and_Carrion_Tower()
gg_trg_Soul_Eater_and_Carrion_Tower = CreateTrigger()
TriggerRegisterAnyUnitEventBJ(gg_trg_Soul_Eater_and_Carrion_Tower, EVENT_PLAYER_UNIT_DAMAGED)
TriggerAddCondition(gg_trg_Soul_Eater_and_Carrion_Tower, Condition(Trig_Soul_Eater_and_Carrion_Tower_Conditions))
TriggerAddAction(gg_trg_Soul_Eater_and_Carrion_Tower, Trig_Soul_Eater_and_Carrion_Tower_Actions)
end
...
function Trig_Siphoning_Tower_Func005Func006A()
SetUnitManaBJ(GetEnumUnit(), (GetUnitStateSwap(UNIT_STATE_MANA, GetEnumUnit()) - (udg_Real_Array_SiphoningAOE[GetItemCharges(GetItemOfTypeFromUnitBJ(GetEventDamageSource(), FourCC("I001")))] - 25.00)))
end
...
if (not (GetUnitAbilityLevelSwapped(FourCC("A01P"), GetEventDamageSource()) == 1)) then
return false
end
return true
end

function Trig_Siphoning_Tower_Func014C()
if (not (GetUnitManaPercent(GetEventDamageSource()) >= 100.00)) then
return false
end
if (not (GetUnitAbilityLevelSwapped(FourCC("A01P"), GetEventDamageSource()) == 1)) then
return false
...
function Trig_Siphoning_Tower_Func018Func012C()
if (not (GetUnitManaPercent(GetEventDamageSource()) <= 5.00)) then
return false
end
return true
end

function Trig_Siphoning_Tower_Func018C()
if (not (GetUnitAbilityLevelSwapped(FourCC("A01P"), GetEventDamageSource()) == 2)) then
return false
end
if (not (GetUnitStateSwap(UNIT_STATE_MANA, GetEventDamageSource()) >= udg_Real_Array_SiphonTowerManaLoss[R2I(BlzGetUnitRealField(GetEventDamageSource(), UNIT_RF_PRIORITY))])) then
return false
end
return true
end
...
if (Trig_Siphoning_Tower_Func005C()) then
        bj_wantDestroyGroup = true
udg_Temp_PointB = GetUnitLoc(BlzGetEventDamageTarget())
udg_UnitGroup_SiphoningTower[GetItemCharges(GetItemOfTypeFromUnitBJ(GetEventDamageSource(), FourCC("I001")))] = GetUnitsInRangeOfLocAll(udg_Real_Array_SiphoningAOE[GetItemCharges(GetItemOfTypeFromUnitBJ(GetEventDamageSource(), FourCC("I001")))], udg_Temp_PointB)
        RemoveLocation(udg_Temp_PointB)
...
ForGroupBJ(udg_UnitGroup_SiphoningTower[GetItemCharges(GetItemOfTypeFromUnitBJ(GetEventDamageSource(), FourCC("I001")))], Trig_Siphoning_Tower_Func005Func006A)
else
end
if (Trig_Siphoning_Tower_Func010C()) then
SetUnitManaBJ(GetEventDamageSource(), (GetUnitStateSwap(UNIT_STATE_MANA, GetEventDamageSource()) + (GetEventDamage() * udg_Real_Array_SiphonTowerManaGain[R2I(BlzGetUnitRealField(GetEventDamageSource(), UNIT_RF_PRIORITY))])))
else
end
if (Trig_Siphoning_Tower_Func014C()) then
SetUnitAbilityLevelSwapped(FourCC("A01P"), GetEventDamageSource(), 2)
else
end
if (Trig_Siphoning_Tower_Func018C()) then
udg_Temp_PointA = GetUnitLoc(BlzGetEventDamageTarget())
CreateNUnitsAtLoc(1, FourCC("h02A"), GetOwningPlayer(GetEventDamageSource()), udg_Temp_PointA, bj_UNIT_FACING)
UnitAddAbilityBJ(FourCC("A027"), GetLastCreatedUnit())
SetUnitAbilityLevelSwapped(FourCC("A027"), GetEventDamageSource(), R2I(BlzGetUnitRealField(GetEventDamageSource(), UNIT_RF_PRIORITY)))
IssuePointOrderLocBJ(GetLastCreatedUnit(), "monsoon", udg_Temp_PointA)
        RemoveLocation(udg_Temp_PointA)
UnitApplyTimedLifeBJ(11.00, FourCC("BTLF"), GetLastCreatedUnit())
SetUnitManaBJ(GetEventDamageSource(), (GetUnitStateSwap(UNIT_STATE_MANA, GetEventDamageSource()) - udg_Real_Array_SiphonTowerManaLoss[R2I(BlzGetUnitRealField(GetEventDamageSource(), UNIT_RF_PRIORITY))]))
if (Trig_Siphoning_Tower_Func018Func012C()) then
...
function InitTrig_Siphoning_Tower()
gg_trg_Siphoning_Tower = CreateTrigger()
TriggerRegisterAnyUnitEventBJ(gg_trg_Siphoning_Tower, EVENT_PLAYER_UNIT_DAMAGED)
TriggerAddCondition(gg_trg_Siphoning_Tower, Condition(Trig_Siphoning_Tower_Conditions))
TriggerAddAction(gg_trg_Siphoning_Tower, Trig_Siphoning_Tower_Actions)
end

function Trig_Hellfire_Reagent_Give_Conditions()
...
gg_trg_Hellfire_Reagent_Give = CreateTrigger()
TriggerRegisterAnyUnitEventBJ(gg_trg_Hellfire_Reagent_Give, EVENT_PLAYER_UNIT_PICKUP_ITEM)
TriggerAddCondition(gg_trg_Hellfire_Reagent_Give, Condition(Trig_Hellfire_Reagent_Give_Conditions))
TriggerAddAction(gg_trg_Hellfire_Reagent_Give, Trig_Hellfire_Reagent_Give_Actions)
end

function Trig_Hellfire_Reagent_Remove_Conditions()
if (not (GetUnitAbilityLevelSwapped(FourCC("A01N"), GetManipulatingUnit()) == 1)) then
return false
end
if (not (GetUnitTypeId(GetManipulatingUnit()) ~= FourCC("u005"))) then
...
function Trig_Hellfire_Reagent_Remove_Func003C()
...
function Trig_Hellfire_Reagent_Remove_Actions()
if (Trig_Hellfire_Reagent_Remove_Func003C()) then
UnitRemoveAbilityBJ(FourCC("A01V"), GetTriggerUnit())
else
end
end

function InitTrig_Hellfire_Reagent_Remove()
gg_trg_Hellfire_Reagent_Remove = CreateTrigger()
TriggerRegisterAnyUnitEventBJ(gg_trg_Hellfire_Reagent_Remove, EVENT_PLAYER_UNIT_DROP_ITEM)
TriggerAddCondition(gg_trg_Hellfire_Reagent_Remove, Condition(Trig_Hellfire_Reagent_Remove_Conditions))
TriggerAddAction(gg_trg_Hellfire_Reagent_Remove, Trig_Hellfire_Reagent_Remove_Actions)
end

function Trig_Hellfire_Reagent_Upgrade_Conditions()
if (not (GetUnitAbilityLevelSwapped(FourCC("A01N"), GetTriggerUnit()) == 1)) then
return false
end
...
gg_trg_Hellfire_Reagent_Upgrade = CreateTrigger()
TriggerRegisterAnyUnitEventBJ(gg_trg_Hellfire_Reagent_Upgrade, EVENT_PLAYER_UNIT_UPGRADE_FINISH)
TriggerAddCondition(gg_trg_Hellfire_Reagent_Upgrade, Condition(Trig_Hellfire_Reagent_Upgrade_Conditions))
TriggerAddAction(gg_trg_Hellfire_Reagent_Upgrade, Trig_Hellfire_Reagent_Upgrade_Actions)
end
...
function Trig_Inferno_Gate_Soul_Fire_Conditions()
if (not (GetUnitAbilityLevelSwapped(FourCC("A00W"), GetKillingUnitBJ()) == 1)) then
return false
end
...
function Trig_Inferno_Gate_Soul_Fire_Func002002003001()
return (IsUnitAliveBJ(GetFilterUnit()) == true)
end

function Trig_Inferno_Gate_Soul_Fire_Func002002003002()
return (IsUnitEnemy(GetFilterUnit(), GetOwningPlayer(GetKillingUnitBJ())) == true)
end

function Trig_Inferno_Gate_Soul_Fire_Func002002003()
return GetBooleanAnd(Trig_Inferno_Gate_Soul_Fire_Func002002003001(), Trig_Inferno_Gate_Soul_Fire_Func002002003002())
end

function Trig_Inferno_Gate_Soul_Fire_Actions()
udg_Temp_PointA = GetUnitLoc(GetDyingUnit())
udg_UnitGroup_Array_InfernoGateSB[GetConvertedPlayerId(GetOwningPlayer(GetKillingUnitBJ()))] = GetUnitsInRangeOfLocMatching(400.00, udg_Temp_PointA, Condition(Trig_Inferno_Gate_Soul_Fire_Func002002003))
bj_forLoopAIndex = 1
...
function InitTrig_Inferno_Gate_Soul_Fire()
gg_trg_Inferno_Gate_Soul_Fire = CreateTrigger()
TriggerRegisterAnyUnitEventBJ(gg_trg_Inferno_Gate_Soul_Fire, EVENT_PLAYER_UNIT_DEATH)
TriggerAddCondition(gg_trg_Inferno_Gate_Soul_Fire, Condition(Trig_Inferno_Gate_Soul_Fire_Conditions))
TriggerAddAction(gg_trg_Inferno_Gate_Soul_Fire, Trig_Inferno_Gate_Soul_Fire_Actions)
end
...
function Trig_Hellfrost_Enchantment_Armor_Remove_Conditions()
if (not (GetUnitAbilityLevelSwapped(FourCC("A011"), GetEventDamageSource()) == 1)) then
return false
end
return true
end
...
function Trig_Hellfrost_Enchantment_Armor_Remove_Func004Func001Func003A()
BlzSetUnitArmor(GetEnumUnit(), (BlzGetUnitArmor(GetEnumUnit()) - (udg_Real_Array_FrostTowArmorReduce[GetItemCharges(GetItemOfTypeFromUnitBJ(GetEventDamageSource(), FourCC("I00F")))] / 10.00)))
end

function Trig_Hellfrost_Enchantment_Armor_Remove_Func004Func001C()
if (not (udg_Integer_Array_FrostChance[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] <= (10 * GetItemCharges(GetItemOfTypeFromUnitBJ(GetEventDamageSource(), FourCC("I00F")))))) then
return false
end
...
function Trig_Hellfrost_Enchantment_Armor_Remove_Func004Func002Func003A()
BlzSetUnitArmor(GetEnumUnit(), (BlzGetUnitArmor(GetEnumUnit()) - udg_Real_Array_FrostTowArmorReduce[GetItemCharges(GetItemOfTypeFromUnitBJ(GetEventDamageSource(), FourCC("I00F")))]))
end
...
udg_Integer_Array_FrostChance[GetConvertedPlayerId(GetOwningPlayer(GetEventDamageSource()))] = GetRandomInt(1, 100)
if (Trig_Hellfrost_Enchantment_Armor_Remove_Func004C()) then
if (Trig_Hellfrost_Enchantment_Armor_Remove_Func004Func001C()) then
            bj_wantDestroyGroup = true
udg_Temp_PointA = GetUnitLoc(BlzGetEventDamageTarget())
ForGroupBJ(GetUnitsInRangeOfLocAll(BlzGetUnitWeaponRealField(GetEventDamageSource(), UNIT_WEAPON_RF_ATTACK_AREA_OF_EFFECT_SMALL_DAMAGE, 0), udg_Temp_PointA), Trig_Hellfrost_Enchantment_Armor_Remove_Func004Func001Func003A)
            RemoveLocation(udg_Temp_PointA)
SetUnitUserData(GetEventDamageSource(), (GetUnitUserData(GetEventDamageSource()) + 1))
else
end
...
if (Trig_Hellfrost_Enchantment_Armor_Remove_Func004Func002C()) then
            bj_wantDestroyGroup = true
udg_Temp_PointA = GetUnitLoc(BlzGetEventDamageTarget())
ForGroupBJ(GetUnitsInRangeOfLocAll(BlzGetUnitWeaponRealField(GetEventDamageSource(), UNIT_WEAPON_RF_ATTACK_AREA_OF_EFFECT_SMALL_DAMAGE, 0), udg_Temp_PointA), Trig_Hellfrost_Enchantment_Armor_Remove_Func004Func002Func003A)
            RemoveLocation(udg_Temp_PointA)
SetUnitUserData(GetEventDamageSource(), (GetUnitUserData(GetEventDamageSource()) + 1))
else
end
...
TriggerAddCondition(gg_trg_Hellfrost_Enchantment_Armor_Remove, Condition(Trig_Hellfrost_Enchantment_Armor_Remove_Conditions))
TriggerAddAction(gg_trg_Hellfrost_Enchantment_Armor_Remove, Trig_Hellfrost_Enchantment_Armor_Remove_Actions)
end

function Trig_Hellfrost_Enchantment_Reset_Conditions()
if (not (GetUnitAbilityLevelSwapped(FourCC("A011"), GetAttacker()) == 1)) then
return false
end
return true
end

function Trig_Hellfrost_Enchantment_Reset_Actions()
SetUnitUserData(GetAttacker(), 0)
end

function InitTrig_Hellfrost_Enchantment_Reset()
gg_trg_Hellfrost_Enchantment_Reset = CreateTrigger()
TriggerRegisterAnyUnitEventBJ(gg_trg_Hellfrost_Enchantment_Reset, EVENT_PLAYER_UNIT_ATTACKED)
TriggerAddCondition(gg_trg_Hellfrost_Enchantment_Reset, Condition(Trig_Hellfrost_Enchantment_Reset_Conditions))
TriggerAddAction(gg_trg_Hellfrost_Enchantment_Reset, Trig_Hellfrost_Enchantment_Reset_Actions)
end

function Trig_Dichotomous_Box_Gold_Func001Func001Func002Func002C()
...
if (not (udg_Integer_Array_DichBoxGold[GetConvertedPlayerId(GetOwningPlayer(GetEnumUnit()))] == 0)) then
return false
end
return true
end
...
udg_Integer_Array_DichBoxGold[GetConvertedPlayerId(GetOwningPlayer(GetEnumUnit()))] = GetRandomInt(0, (10 * GetItemCharges(GetItemOfTypeFromUnitBJ(GetEnumUnit(), FourCC("I00D")))))
if (Trig_Dichotomous_Box_Gold_Func001Func001Func002C()) then
udg_String_Array_DichBoxMsg[GetConvertedPlayerId(GetOwningPlayer(GetEnumUnit()))] = "0"
else
udg_Integer_Array_DicBoxGoldChance[GetConvertedPlayerId(GetOwningPlayer(GetEnumUnit()))] = GetRandomInt(1, 100)
if (Trig_Dichotomous_Box_Gold_Func001Func001Func002Func002C()) then
...
udg_String_Array_DichBoxMsg[GetConvertedPlayerId(GetOwningPlayer(GetEnumUnit()))] = ("-" .. I2S(udg_Integer_Array_DichBoxGold[GetConvertedPlayerId(GetOwningPlayer(GetEnumUnit()))]))
SetPlayerStateBJ(GetOwningPlayer(GetEnumUnit()), PLAYER_STATE_RESOURCE_GOLD, (GetPlayerState(GetOwningPlayer(GetEnumUnit()), PLAYER_STATE_RESOURCE_GOLD) - udg_Integer_Array_DichBoxGold[GetConvertedPlayerId(GetOwningPlayer(GetEnumUnit()))]))
end
end
PlaySoundOnUnitBJ(gg_snd_ReceiveGold, 100, GetEnumUnit())
...
function Trig_Argent_Conduit_Actions()
if (Trig_Argent_Conduit_Func001C()) then
udg_Temp_PointA = GetUnitLoc(GetManipulatingUnit())
UnitDropItemPointLoc(GetManipulatingUnit(), GetItemOfTypeFromUnitBJ(GetManipulatingUnit(), FourCC("I004")), udg_Temp_PointA)
        RemoveLocation(udg_Temp_PointA)
else
end
end

function InitTrig_Argent_Conduit()
gg_trg_Argent_Conduit = CreateTrigger()
TriggerRegisterAnyUnitEventBJ(gg_trg_Argent_Conduit, EVENT_PLAYER_UNIT_PICKUP_ITEM)
TriggerAddAction(gg_trg_Argent_Conduit, Trig_Argent_Conduit_Actions)
end
...
function Trig_Hellfire_Reagent_Actions()
if (Trig_Hellfire_Reagent_Func001C()) then
udg_Temp_PointA = GetUnitLoc(GetManipulatingUnit())
UnitDropItemPointLoc(GetManipulatingUnit(), GetItemOfTypeFromUnitBJ(GetManipulatingUnit(), FourCC("I001")), udg_Temp_PointA)
        RemoveLocation(udg_Temp_PointA)
else
end
end

function InitTrig_Hellfire_Reagent()
...
function Trig_Demonic_Artefact_Func001C()
if (not (GetUnitAbilityLevelSwapped(FourCC("A01W"), GetManipulatingUnit()) ~= 1)) then
return false
end
...
function Trig_Demonic_Artefact_Actions()
if (Trig_Demonic_Artefact_Func001C()) then
udg_Temp_PointA = GetUnitLoc(GetManipulatingUnit())
UnitDropItemPointLoc(GetManipulatingUnit(), GetItemOfTypeFromUnitBJ(GetManipulatingUnit(), FourCC("I008")), udg_Temp_PointA)
        RemoveLocation(udg_Temp_PointA)
else
end
end

function InitTrig_Demonic_Artefact()
gg_trg_Demonic_Artefact = CreateTrigger()
TriggerRegisterAnyUnitEventBJ(gg_trg_Demonic_Artefact, EVENT_PLAYER_UNIT_PICKUP_ITEM)
TriggerAddAction(gg_trg_Demonic_Artefact, Trig_Demonic_Artefact_Actions)
end

function Trig_Creep_Count_Func002C()
if (GetOwningPlayer(GetTriggerUnit()) == Player(10)) then
return true
end
if (GetOwningPlayer(GetTriggerUnit()) == Player(11)) then
...
function Trig_Creep_Count_Conditions()
if (not (GetUnitTypeId(GetTriggerUnit()) ~= FourCC("n007"))) then
return false
end
if (not Trig_Creep_Count_Func002C()) then
return false
end
return true
end
...
TriggerAddCondition(gg_trg_Creep_Count, Condition(Trig_Creep_Count_Conditions))
TriggerAddAction(gg_trg_Creep_Count, Trig_Creep_Count_Actions)
end

function Trig_Creep_Teleport_1_Conditions()
if (not (GetUnitTypeId(GetTriggerUnit()) ~= FourCC("n007"))) then
return false
end
return true
...
function Trig_Creep_Teleport_1_Func002C()
...
TriggerAddCondition(gg_trg_Creep_Teleport_1, Condition(Trig_Creep_Teleport_1_Conditions))
TriggerAddAction(gg_trg_Creep_Teleport_1, Trig_Creep_Teleport_1_Actions)
end

function Trig_Creep_Teleport_2_Conditions()
if (not (GetUnitTypeId(GetTriggerUnit()) ~= FourCC("n007"))) then
return false
end
return true
...
function Trig_Creep_Teleport_2_Func002C()
...
TriggerAddCondition(gg_trg_Creep_Teleport_2, Condition(Trig_Creep_Teleport_2_Conditions))
TriggerAddAction(gg_trg_Creep_Teleport_2, Trig_Creep_Teleport_2_Actions)
end

function Trig_Creep_Teleport_3_Conditions()
if (not (GetUnitTypeId(GetTriggerUnit()) ~= FourCC("n007"))) then
return false
end
return true
...
function Trig_Creep_Teleport_3_Func002C()
...
TriggerAddCondition(gg_trg_Creep_Teleport_3, Condition(Trig_Creep_Teleport_3_Conditions))
TriggerAddAction(gg_trg_Creep_Teleport_3, Trig_Creep_Teleport_3_Actions)
end

function Trig_Creep_Teleport_4_Conditions()
if (not (GetUnitTypeId(GetTriggerUnit()) ~= FourCC("n007"))) then
return false
end
return true
...
function Trig_Creep_Teleport_4_Func002C()
...
TriggerAddCondition(gg_trg_Creep_Teleport_4, Condition(Trig_Creep_Teleport_4_Conditions))
TriggerAddAction(gg_trg_Creep_Teleport_4, Trig_Creep_Teleport_4_Actions)
end

function Trig_Creep_Teleport_5_Conditions()
if (not (GetUnitTypeId(GetTriggerUnit()) ~= FourCC("n007"))) then
return false
end
return true
...
function Trig_Creep_Teleport_5_Func002C()
...
TriggerAddCondition(gg_trg_Creep_Teleport_5, Condition(Trig_Creep_Teleport_5_Conditions))
TriggerAddAction(gg_trg_Creep_Teleport_5, Trig_Creep_Teleport_5_Actions)
end

function Trig_Creep_Teleport_6_Conditions()
if (not (GetUnitTypeId(GetTriggerUnit()) ~= FourCC("n007"))) then
return false
end
return true
...
function Trig_Creep_Teleport_6_Func002C()
...
TriggerAddCondition(gg_trg_Creep_Teleport_6, Condition(Trig_Creep_Teleport_6_Conditions))
TriggerAddAction(gg_trg_Creep_Teleport_6, Trig_Creep_Teleport_6_Actions)
end

function Trig_Creep_Teleport_7_Conditions()
if (not (GetUnitTypeId(GetTriggerUnit()) ~= FourCC("n007"))) then
return false
end
return true
...
function Trig_Creep_Teleport_7_Func002C()
...
TriggerAddCondition(gg_trg_Creep_Teleport_7, Condition(Trig_Creep_Teleport_7_Conditions))
TriggerAddAction(gg_trg_Creep_Teleport_7, Trig_Creep_Teleport_7_Actions)
end

function Trig_Creep_Teleport_8_Conditions()
if (not (GetUnitTypeId(GetTriggerUnit()) ~= FourCC("n007"))) then
return false
end
return true
...
function Trig_Creep_Teleport_8_Func002C()
...
TriggerAddCondition(gg_trg_Creep_Teleport_8, Condition(Trig_Creep_Teleport_8_Conditions))
...
function Trig_Creep_Spawn_3_Func008C()
if (GetOwningPlayer(GetTriggerUnit()) == Player(11)) then
return true
end
if (GetOwningPlayer(GetTriggerUnit()) == Player(10)) then
...
function config()
SetMapName("TRIGSTR_1904")
SetMapDescription("TRIGSTR_1906")
SetPlayers(9)
SetTeams(9)
