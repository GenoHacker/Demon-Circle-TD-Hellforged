...
u = BlzCreateUnitWithSkin(p, FourCC("u005"), -2561.3, 4612.2, 90.399, FourCC("u005"))
end
...
u = BlzCreateUnitWithSkin(p, FourCC("u005"), -1024.7, 3586.4, 44.945, FourCC("u005"))
end
...
u = BlzCreateUnitWithSkin(p, FourCC("u005"), -2.2, 2051.2, 0.070, FourCC("u005"))
end
...
u = BlzCreateUnitWithSkin(p, FourCC("u005"), -1026.5, 513.2, 315.017, FourCC("u005"))
end
...
u = BlzCreateUnitWithSkin(p, FourCC("u005"), -2561.9, -510.9, 270.055, FourCC("u005"))
end
...
u = BlzCreateUnitWithSkin(p, FourCC("u005"), -4096.7, 514.9, 224.956, FourCC("u005"))
end
...
DisplayTimedTextToForce(GetPlayersAll(), 5.00, (GetPlayerName(GetTriggerPlayer()) .. " has increased difficulty by 10%."))
...
DisplayTimedTextToForce(GetPlayersAll(), 5.00, (GetPlayerName(GetTriggerPlayer()) .. " has decreased difficulty by 5%."))
SetPlayerHandicapBJ(Player(10), I2R(udg_Integer_EnemyHandicap))
SetPlayerHandicapBJ(Player(11), I2R(udg_Integer_EnemyHandicap))
DisplayTimedTextToForce(GetPlayersAll(), 5.00, ("Difficulty is now: " .. (I2S(udg_Integer_EnemyHandicap) .. "%")))
...
function InitTrig_Wave_Buffs()
gg_trg_Wave_Buffs = CreateTrigger()
DisableTrigger(gg_trg_Wave_Buffs)
...
function Trig_Fluctation_Tower_AddRemove_Func001C()
if (not (GetUnitAbilityLevelSwapped(FourCC("A022"), GetConstructedStructure()) == 1)) then
return false
end
return true
end

function Trig_Fluctation_Tower_AddRemove_Func002C()
...
function Trig_Fluctation_Tower_AddRemove_Func003C()
if (not (GetUnitAbilityLevelSwapped(FourCC("A022"), GetSpellAbilityUnit()) == 1)) then
return false
end
if (not (GetSpellAbilityId() == FourCC("A000"))) then
return false
...
function Trig_Fluctation_Tower_AddRemove_Actions()
if (Trig_Fluctation_Tower_AddRemove_Func001C()) then
GroupAddUnitSimple(GetConstructedStructure(), udg_UnitGroup_FluctuationTowerMana)
else
end
if (Trig_Fluctation_Tower_AddRemove_Func002C()) then
GroupAddUnitSimple(GetTriggerUnit(), udg_UnitGroup_FluctuationTowerMana)
else
end
if (Trig_Fluctation_Tower_AddRemove_Func003C()) then
GroupRemoveUnitSimple(GetSpellAbilityUnit(), udg_UnitGroup_FluctuationTowerMana)
else
end
end

function InitTrig_Fluctation_Tower_AddRemove()
gg_trg_Fluctation_Tower_AddRemove = CreateTrigger()
TriggerRegisterAnyUnitEventBJ(gg_trg_Fluctation_Tower_AddRemove, EVENT_PLAYER_UNIT_CONSTRUCT_FINISH)
TriggerRegisterAnyUnitEventBJ(gg_trg_Fluctation_Tower_AddRemove, EVENT_PLAYER_UNIT_UPGRADE_FINISH)
TriggerRegisterAnyUnitEventBJ(gg_trg_Fluctation_Tower_AddRemove, EVENT_PLAYER_UNIT_SPELL_CAST)
TriggerAddAction(gg_trg_Fluctation_Tower_AddRemove, Trig_Fluctation_Tower_AddRemove_Actions)
end
...
function Trig_Fluctuation_Tower_Ability_Func005Func001Func001C()
if (not (GetUnitTypeId(GetEventDamageSource()) == FourCC("u01E"))) then
return false
end
return true
end

function Trig_Fluctuation_Tower_Ability_Func005Func001C()
if (not (GetUnitTypeId(GetEventDamageSource()) == FourCC("u01D"))) then
return false
end
return true
end
...
if (not (GetUnitTypeId(GetEventDamageSource()) == FourCC("u01F"))) then
return false
end
return true
end

function Trig_Fluctuation_Tower_Ability_Func006Func003Func001Func001C()
if (not (GetItemCharges(GetItemOfTypeFromUnitBJ(GetEventDamageSource(), FourCC("I004"))) == 3)) then
return false
end
return true
end

function Trig_Fluctuation_Tower_Ability_Func006Func003Func001C()
if (not (GetItemCharges(GetItemOfTypeFromUnitBJ(GetEventDamageSource(), FourCC("I004"))) == 2)) then
return false
end
return true
end

function Trig_Fluctuation_Tower_Ability_Func006Func003C()
if (not (GetItemCharges(GetItemOfTypeFromUnitBJ(GetEventDamageSource(), FourCC("I004"))) == 1)) then
return false
end
return true
end

function Trig_Fluctuation_Tower_Ability_Func006C()
...
function Trig_Fluctuation_Tower_Ability_Func007Func003Func001Func001C()
if (not (GetItemCharges(GetItemOfTypeFromUnitBJ(GetEventDamageSource(), FourCC("I004"))) == 3)) then
return false
end
return true
...
function Trig_Fluctuation_Tower_Ability_Func007Func003Func001C()
if (not (GetItemCharges(GetItemOfTypeFromUnitBJ(GetEventDamageSource(), FourCC("I004"))) == 2)) then
return false
end
return true
...
function Trig_Fluctuation_Tower_Ability_Func007Func003C()
if (not (GetItemCharges(GetItemOfTypeFromUnitBJ(GetEventDamageSource(), FourCC("I004"))) == 1)) then
return false
end
return true
...
function Trig_Fluctuation_Tower_Ability_Func007C()
...
BlzSetUnitAttackCooldown(GetEventDamageSource(), GetRandomReal(3.00, 4.00), 1)
else
if (Trig_Fluctuation_Tower_Ability_Func005Func001C()) then
BlzSetUnitAttackCooldown(GetEventDamageSource(), GetRandomReal(2.00, 5.00), 1)
else
if (Trig_Fluctuation_Tower_Ability_Func005Func001Func001C()) then
BlzSetUnitAttackCooldown(GetEventDamageSource(), GetRandomReal(1.00, 6.00), 1)
else
end
end
end
if (Trig_Fluctuation_Tower_Ability_Func006C()) then
...
if (Trig_Fluctuation_Tower_Ability_Func006Func003C()) then
SetUnitAbilityLevelSwapped(FourCC("A023"), GetEventDamageSource(), 2)
SetUnitAbilityLevelSwapped(FourCC("A024"), GetEventDamageSource(), 1)
else
if (Trig_Fluctuation_Tower_Ability_Func006Func003Func001C()) then
SetUnitAbilityLevelSwapped(FourCC("A023"), GetEventDamageSource(), 3)
SetUnitAbilityLevelSwapped(FourCC("A024"), GetEventDamageSource(), 1)
else
if (Trig_Fluctuation_Tower_Ability_Func006Func003Func001Func001C()) then
SetUnitAbilityLevelSwapped(FourCC("A023"), GetEventDamageSource(), 4)
SetUnitAbilityLevelSwapped(FourCC("A024"), GetEventDamageSource(), 1)
else
end
end
...
if (Trig_Fluctuation_Tower_Ability_Func007C()) then
SetUnitAbilityLevelSwapped(FourCC("A024"), GetEventDamageSource(), 2)
SetUnitAbilityLevelSwapped(FourCC("A023"), GetEventDamageSource(), 1)
if (Trig_Fluctuation_Tower_Ability_Func007Func003C()) then
SetUnitAbilityLevelSwapped(FourCC("A024"), GetEventDamageSource(), 3)
SetUnitAbilityLevelSwapped(FourCC("A023"), GetEventDamageSource(), 1)
else
if (Trig_Fluctuation_Tower_Ability_Func007Func003Func001C()) then
SetUnitAbilityLevelSwapped(FourCC("A024"), GetEventDamageSource(), 4)
SetUnitAbilityLevelSwapped(FourCC("A023"), GetEventDamageSource(), 1)
else
if (Trig_Fluctuation_Tower_Ability_Func007Func003Func001Func001C()) then
SetUnitAbilityLevelSwapped(FourCC("A024"), GetEventDamageSource(), 5)
SetUnitAbilityLevelSwapped(FourCC("A023"), GetEventDamageSource(), 1)
else
end
end
...
function Trig_Fluctuation_Tower_Mana_Func001Func001Func001C()
if (not (GetUnitTypeId(GetEnumUnit()) == FourCC("u01F"))) then
return false
end
return true
end

function Trig_Fluctuation_Tower_Mana_Func001Func001Func002C()
if (not (GetUnitTypeId(GetEnumUnit()) == FourCC("u01E"))) then
return false
end
return true
end

function Trig_Fluctuation_Tower_Mana_Func001Func001Func003C()
if (not (GetUnitTypeId(GetEnumUnit()) == FourCC("u01D"))) then
return false
end
return true
end

function Trig_Fluctuation_Tower_Mana_Func001Func001Func004C()
if (not (GetUnitTypeId(GetEnumUnit()) == FourCC("u01F"))) then
return false
end
return true
...
function Trig_Fluctuation_Tower_Mana_Func001Func001Func005C()
if (not (GetUnitTypeId(GetEnumUnit()) == FourCC("u01D"))) then
return false
end
return true
...
function Trig_Fluctuation_Tower_Mana_Func001Func001Func006C()
if (not (GetUnitTypeId(GetEnumUnit()) == FourCC("u01E"))) then
return false
end
return true
...
function Trig_Fluctuation_Tower_Mana_Func001Func001C()
...
if (Trig_Fluctuation_Tower_Mana_Func001Func001C()) then
if (Trig_Fluctuation_Tower_Mana_Func001Func001Func004C()) then
BlzSetUnitBaseDamage(GetEnumUnit(), (200 + R2I(GetUnitStateSwap(UNIT_STATE_MANA, GetEnumUnit()))), 0)
else
end
if (Trig_Fluctuation_Tower_Mana_Func001Func001Func005C()) then
BlzSetUnitBaseDamage(GetEnumUnit(), (350 + R2I(GetUnitStateSwap(UNIT_STATE_MANA, GetEnumUnit()))), 0)
else
end
if (Trig_Fluctuation_Tower_Mana_Func001Func001Func006C()) then
BlzSetUnitBaseDamage(GetEnumUnit(), (500 + R2I(GetUnitStateSwap(UNIT_STATE_MANA, GetEnumUnit()))), 0)
else
end
else
if (Trig_Fluctuation_Tower_Mana_Func001Func001Func001C()) then
BlzSetUnitBaseDamage(GetEnumUnit(), 200, 0)
else
end
if (Trig_Fluctuation_Tower_Mana_Func001Func001Func002C()) then
BlzSetUnitBaseDamage(GetEnumUnit(), 500, 0)
else
end
if (Trig_Fluctuation_Tower_Mana_Func001Func001Func003C()) then
BlzSetUnitBaseDamage(GetEnumUnit(), 350, 0)
else
end
end
end
...
function Trig_Monstrosity_Tower_Sanguine_Stacks_Func003Func001Func001C()
...
if (Trig_Monstrosity_Tower_Sanguine_Stacks_Func003Func001Func001C()) then
CreateNUnitsAtLoc(1, FourCC("h02A"), GetOwningPlayer(GetEventDamageSource()), udg_Temp_PointA, bj_UNIT_FACING)
...
function Trig_Soul_Eater_and_Carrion_Tower_Func003Func005Func005C()
...
function Trig_Soul_Eater_and_Carrion_Tower_Func003Func005C()
...
CreateNUnitsAtLoc(1, FourCC("h02A"), GetOwningPlayer(GetEventDamageSource()), udg_Temp_PointA, bj_UNIT_FACING)
UnitApplyTimedLifeBJ(1.00, FourCC("BTLF"), GetLastCreatedUnit())
UnitDamageTargetBJ(GetLastCreatedUnit(), BlzGetEventDamageTarget(), (GetEventDamage() * 0.33), ATTACK_TYPE_CHAOS, DAMAGE_TYPE_UNIVERSAL)
else
if (Trig_Soul_Eater_and_Carrion_Tower_Func003Func005C()) then
udg_Temp_PointA = GetUnitLoc(GetEventDamageSource())
CreateNUnitsAtLoc(1, FourCC("h02A"), GetOwningPlayer(GetEventDamageSource()), udg_Temp_PointA, bj_UNIT_FACING)
UnitApplyTimedLifeBJ(1.00, FourCC("BTLF"), GetLastCreatedUnit())
UnitDamageTargetBJ(GetLastCreatedUnit(), BlzGetEventDamageTarget(), (GetEventDamage() * 0.66), ATTACK_TYPE_CHAOS, DAMAGE_TYPE_UNIVERSAL)
else
if (Trig_Soul_Eater_and_Carrion_Tower_Func003Func005Func005C()) then
udg_Temp_PointA = GetUnitLoc(GetEventDamageSource())
CreateNUnitsAtLoc(1, FourCC("h02A"), GetOwningPlayer(GetEventDamageSource()), udg_Temp_PointA, bj_UNIT_FACING)
UnitApplyTimedLifeBJ(1.00, FourCC("BTLF"), GetLastCreatedUnit())
UnitDamageTargetBJ(GetLastCreatedUnit(), BlzGetEventDamageTarget(), (GetEventDamage() * 1.00), ATTACK_TYPE_CHAOS, DAMAGE_TYPE_UNIVERSAL)
else
end
end
end
...
function Trig_Siphoning_Tower_Func001Func001Func001Func005A()
SetUnitManaBJ(GetEnumUnit(), (GetUnitStateSwap(UNIT_STATE_MANA, GetEnumUnit()) - 100.00))
end

function Trig_Siphoning_Tower_Func001Func001Func001C()
...
function Trig_Siphoning_Tower_Func001Func001Func006A()
SetUnitManaBJ(GetEnumUnit(), (GetUnitStateSwap(UNIT_STATE_MANA, GetEnumUnit()) - 75.00))
end

function Trig_Siphoning_Tower_Func001Func001C()
...
function Trig_Siphoning_Tower_Func001Func006A()
...
function Trig_Siphoning_Tower_Func004Func002C()
...
function Trig_Siphoning_Tower_Func004Func003Func002C()
...
function Trig_Siphoning_Tower_Func004Func003Func003Func002C()
...
function Trig_Siphoning_Tower_Func004Func003Func003C()
if (not Trig_Siphoning_Tower_Func004Func003Func003Func002C()) then
return false
end
return true
end

function Trig_Siphoning_Tower_Func004Func003C()
if (not Trig_Siphoning_Tower_Func004Func003Func002C()) then
return false
end
return true
end
...
if (not Trig_Siphoning_Tower_Func004Func002C()) then
return false
end
return true
end

function Trig_Siphoning_Tower_Func005Func001Func001C()
...
function Trig_Siphoning_Tower_Func005Func001C()
if (not (GetUnitManaPercent(GetEventDamageSource()) <= 10.00)) then
return false
end
...
function Trig_Siphoning_Tower_Func006Func001Func001C()
if (not (GetUnitManaPercent(GetEventDamageSource()) >= 99.00)) then
return false
end
if (not (GetUnitAbilityLevelSwapped(FourCC("A01O"), GetEventDamageSource()) == 1)) then
return false
end
return true
end

function Trig_Siphoning_Tower_Func006Func001C()
if (not (GetUnitManaPercent(GetEventDamageSource()) >= 99.00)) then
return false
end
if (not (GetUnitAbilityLevelSwapped(FourCC("A01Q"), GetEventDamageSource()) == 1)) then
return false
end
return true
end
...
if (not (GetUnitStateSwap(UNIT_STATE_MANA, GetEventDamageSource()) >= 160.00)) then
return false
end
return true
end
...
if (not (GetUnitStateSwap(UNIT_STATE_MANA, GetEventDamageSource()) >= 80.00)) then
return false
end
return true
end
...
if (not (GetUnitStateSwap(UNIT_STATE_MANA, GetEventDamageSource()) >= 40.00)) then
return false
end
return true
end
...
ForGroupBJ(udg_UnitGroup_SiphoningTower[1], Trig_Siphoning_Tower_Func001Func006A)
else
if (Trig_Siphoning_Tower_Func001Func001C()) then
udg_Temp_PointB = GetUnitLoc(BlzGetEventDamageTarget())
            bj_wantDestroyGroup = true
...
ForGroupBJ(udg_UnitGroup_SiphoningTower[2], Trig_Siphoning_Tower_Func001Func001Func006A)
else
if (Trig_Siphoning_Tower_Func001Func001Func001C()) then
udg_Temp_PointB = GetUnitLoc(BlzGetEventDamageTarget())
                bj_wantDestroyGroup = true
...
ForGroupBJ(udg_UnitGroup_SiphoningTower[3], Trig_Siphoning_Tower_Func001Func001Func001Func005A)
else
end
end
end
...
if (Trig_Siphoning_Tower_Func005Func001C()) then
SetUnitAbilityLevelSwapped(FourCC("A01Q"), GetEventDamageSource(), 1)
else
if (Trig_Siphoning_Tower_Func005Func001Func001C()) then
...
if (Trig_Siphoning_Tower_Func006Func001C()) then
SetUnitAbilityLevelSwapped(FourCC("A01Q"), GetEventDamageSource(), 2)
else
if (Trig_Siphoning_Tower_Func006Func001Func001C()) then
...
function Trig_Hellfire_Reagent_Give_Func006Func001Func002C()
if (not (GetItemCharges(GetItemOfTypeFromUnitBJ(GetManipulatingUnit(), FourCC("I001"))) == 3)) then
return false
end
return true
end

function Trig_Hellfire_Reagent_Give_Func006Func001C()
if (not (GetItemCharges(GetItemOfTypeFromUnitBJ(GetManipulatingUnit(), FourCC("I001"))) == 2)) then
return false
end
return true
end

function Trig_Hellfire_Reagent_Give_Func006C()
if (not (GetItemCharges(GetItemOfTypeFromUnitBJ(GetManipulatingUnit(), FourCC("I001"))) == 1)) then
return false
end
return true
end
...
UnitRemoveAbilityBJ(FourCC("A01V"), GetManipulatingUnit())
UnitRemoveAbilityBJ(FourCC("A01U"), GetManipulatingUnit())
UnitRemoveAbilityBJ(FourCC("A01W"), GetManipulatingUnit())
if (Trig_Hellfire_Reagent_Give_Func006C()) then
UnitAddAbilityBJ(FourCC("A01V"), GetManipulatingUnit())
else
if (Trig_Hellfire_Reagent_Give_Func006Func001C()) then
UnitAddAbilityBJ(FourCC("A01U"), GetManipulatingUnit())
else
if (Trig_Hellfire_Reagent_Give_Func006Func001Func002C()) then
UnitAddAbilityBJ(FourCC("A01W"), GetManipulatingUnit())
else
end
end
end
...
UnitRemoveAbilityBJ(FourCC("A01U"), GetTriggerUnit())
UnitRemoveAbilityBJ(FourCC("A01W"), GetTriggerUnit())
else
end
end
...
function Trig_Hellfire_Reagent_Upgrade_Func003Func001Func001C()
if (not (GetItemCharges(GetItemOfTypeFromUnitBJ(GetTriggerUnit(), FourCC("I001"))) == 3)) then
return false
end
return true
end

function Trig_Hellfire_Reagent_Upgrade_Func003Func001C()
if (not (GetItemCharges(GetItemOfTypeFromUnitBJ(GetTriggerUnit(), FourCC("I001"))) == 2)) then
return false
end
return true
end

function Trig_Hellfire_Reagent_Upgrade_Func003C()
...
if (Trig_Hellfire_Reagent_Upgrade_Func003C()) then
UnitAddAbilityBJ(FourCC("A01V"), GetTriggerUnit())
else
if (Trig_Hellfire_Reagent_Upgrade_Func003Func001C()) then
UnitAddAbilityBJ(FourCC("A01U"), GetTriggerUnit())
else
if (Trig_Hellfire_Reagent_Upgrade_Func003Func001Func001C()) then
UnitAddAbilityBJ(FourCC("A01W"), GetTriggerUnit())
else
end
end
end
...
InitTrig_Fluctation_Tower_AddRemove()
